...
exports.create = async (data) => {
    const result = await db.query(`INSERT INTO users (firstname, lastname, email, user_password, age, user_address, created_at, last_active, last_modified, account_locked, verified) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
